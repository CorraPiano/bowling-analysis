...
def process_video_for_lane_detection(input_video: str, output_video: str, output_csv: str):
    """
    Processes an input video to detect and highlight moving circular objects, 
    and saves their center coordinates to a CSV file.
...
def process_video_with_absdiff(input_video: str, input_points: str, output_video: str, output_csv: str, output_csv_circles: str):
    """
    Processes an input video to detect and highlight moving circular objects, 
    and saves their center coordinates to a CSV file.
...
if __name__ == "__main__":
    ...
    #process_video_for_lane_detection(INPUT_VIDEO_PATH, OUTPUT_VIDEO_PATH, OUTPUT_CSV_PATH)
