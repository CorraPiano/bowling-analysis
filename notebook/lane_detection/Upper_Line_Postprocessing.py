...
def postprocessing_upper_lines(cap, bottom_lines, left_lines, right_lines, upper_lines_raw, avg_motion, output_path):
    ...
    # Save the DataFrame to a CSV file
    publish_csv_lane_points(output_path, points_df)
